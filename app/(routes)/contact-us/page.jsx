/**
 * صفحة اتصل بنا
 * هذه الصفحة تعرض معلومات الاتصال ونموذج للتواصل مع فريق الدعم
 * تتضمن رقم الهاتف، البريد الإلكتروني، العنوان، وساعات العمل
 *
 * Contact Us Page
 * This page displays contact information and a form to reach the support team
 * Includes phone number, email, address, and working hours
 */
