/**
 * صفحة تعديل الإعلان
 * هذه الصفحة تسمح للمستخدمين بتعديل تفاصيل إعلاناتهم
 * يمكن تحديث المعلومات، الصور، السعر، وجميع التفاصيل الأخرى
 *
 * Edit Listing Page
 * This page allows users to edit their listing details
 * Can update information, images, price, and all other details
 */
...
function EditListing() {
  const { user, userProfile, getUserImage, getDisplayName } = useAuth();
