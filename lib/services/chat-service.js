...
export class ChatService {
  ...
  static async getUserConversations(userAuthId) {
    try {
      console.log("🔍 Fetching conversations for user:", userAuthId);
      ...
      const processedData = await Promise.all(
        data.map(async (conv) => {
          ...
          // Get last message (use maybeSingle to handle no messages)
      ...
      console.log("✅ Processed conversations:", processedData.length);
